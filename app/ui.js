...
var UI = {
    ...
    start: function(callback) {
        ...
        var autoconnect = WebUtil.getConfigVar('autoconnect'); 
        // bryfry edit start // check if path has been provided via url param
        var path = WebUtil.getConfigVar('path');               // bryfry
        if (path != null && typeof path == "string") {         // bryfry
            autoconnect = 'true';                              // bryfry
        }                                                      // bryfry
        // bryfry edit end //
    ...
    initSettings: function() {
        ...
        UI.initSetting('resize', 'scale'); // bryfry - default scale
 ...
 * ------v------*/
    ...
    connect: function(event, password) {
        ...
        if (typeof password === 'undefined') {
            password = WebUtil.getConfigVar('password', 'alta3'); // bryfry - add default password
 ...
 * ------v------*/
    ...
    applyResizeMode: function() {
        ...
        UI.rfb.scaleViewport = UI.getSetting('resize', 'scale') === 'scale';
        UI.rfb.resizeSession = UI.getSetting('resize') === 'remote';
    },
